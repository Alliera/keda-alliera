...
- **RabbitMQ Scaler**: Added optional boolean field 'allowSubpathsOnHost' to allow/disallow subpaths in the connection string ([#2634](https://github.com/kedacore/keda/issues/2634))
